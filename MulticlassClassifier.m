...
SVMModel = fitcecoc(Xv1Train,Yv1Train,'Learners',t,'Coding','onevsall'); % One vs. One
% SVMModel = fitcecoc(Xv1Train,Yv1Train,'Coding','onevsall'); % One vs. All
% t = templateKNN('NumNeighbors',5,'Standardize',1); % Nearest Neighbor
% SVMModel = fitcecoc(Xv1Train,Yv1Train,'Learners',t);
