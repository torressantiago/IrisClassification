%% Binary classifier 4D with kernel
load fisheriris
...
% SVMModel = fitcsvm(Xv1Train,Yv1Train,'KernelFunction','polynomial','PolynomialOrder',1,'KernelScale','auto');
SVMModel = fitcsvm(Xv1Train,Yv1Train,'KernelFunction','gaussian','KernelScale','auto');
